...
location.href=href;},500);});}});if(skel.vars.IEVersion<9)
...
$banner.each(function(){var $this=$(this),$image=$this.find('.image'),$img=$image.find('img');if($image.length>0){$this.css('background-image','url('+$img.attr('src')+')');$image.hide();}});var $menu=$('#menu'),$menuInner;$menu.wrapInner('<div class="inner"></div>');$menuInner=$menu.children('.inner');$menu._locked=false;$menu._lock=function(){if($menu._locked)
...
$menu._hide();});});(function(){load_css_dynamically=(function(uri){$("<link />",{rel:"stylesheet",type:"text/css",href:uri}).appendTo("head");});load_css_dynamically("https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,300italic,600,600italic");load_css_dynamically("./assets/css/font-awesome.min.css");$('#contact_form').append("<iframe src=\"https://docs.google.com/forms/d/e/1FAIpQLSdks_CPOPL4I97_bY50wby_6tF3WnUYFnFvjr25Q_vcwRnDow/viewform?embedded=true\" width=\"100%\" height=\"100%\" frameborder=\"0\" marginheight=\"0\" marginwidth=\"0\">読み込んでいます...</iframe>");})();})(jQuery);
